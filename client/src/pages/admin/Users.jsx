...
const Users = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-center mb-8">Admins</h1>
      {loading ? (
              ...
              {admins.map((admin) => (
                <tr key={admin.id}>
                  ...
                  <td className="px-4 py-2 border">
                    {admin.verificationStatus ? "Verified" : "Not Verified"}
                  </td>
                  <td className="px-4 py-2 border">
                    <button
                      className="bg-blue-500 text-white py-1 px-3 rounded"
                      onClick={() =>
                        handleStatusChange(admin.id, !admin.verificationStatus)
                      }
                    >
